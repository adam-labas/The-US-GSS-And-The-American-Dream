...
```{r fig1, fig.cap="write a figure caption here", echo = FALSE, fig.width=12, fig.height=10, echo=FALSE}
...
```{r, fig.cap="write a figure caption here", echo = FALSE, fig.width=12, fig.height=10, echo=FALSE}
...
```{r, fig.cap="write a figure caption here", echo = FALSE, fig.width=9, fig.height=6, echo=FALSE}
